...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  modifier checkValue(uint _upc) {
    ...
    // https://ethereum.stackexchange.com/questions/99731/how-do-i-pass-msg-sender-to-a-struct-as-a-payable-address
  ...
  function buyItem(uint _upc) public payable 
    ...
    address payable originFarmerAddress = address(uint160(items[_upc].originFarmerID)); 
    originFarmerAddress.transfer(items[_upc].productPrice);
